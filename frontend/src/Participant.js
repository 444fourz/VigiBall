      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-slate-900 p-10 rounded-[2rem] border border-slate-800 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl font-black transition-all uppercase tracking-widest ${!guess || guess <= 0
        ...
        {phase === 3 && (
          <div className="max-w-md mx-auto relative bg-slate-900 p-10 rounded-[2rem] border border-slate-800 text-center shadow-2xl animate-in fade-in zoom-in duration-300 overflow-hidden">
            ...
            <div className={`absolute top-0 -right-52 w-48 transition-all duration-1000 transform hidden md:block ${showNote ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'
              }`}>
            ...
            <button
              ...
              className={`w-full py-4 rounded-xl font-black transition-all ${!finalBid || finalBid <= 0
                  ? 'bg-slate-700 text-slate-500 cursor-not-allowed'
