...
> A full-stack web application developed as part of a Final Year Dissertation at Aston University.

The project investigates **Automation Bias** in professional football scouting by using a custom-built **Market Value Prediction Algorithm (MVPA)**.
